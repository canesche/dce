; ModuleID = 'benchmarks/test8.vssa.ll'
source_filename = "benchmarks/test8.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [8 x i8] c"a sge b\00", align 1
...
while.cond:                                       ; preds = %if.end, %entry
  %a.addr.0 = phi i32 [ 0, %entry ], [ %inc, %if.end ]
  %cmp = icmp slt i32 %a.addr.0, 63
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %vSSA_sigma = phi i32 [ %a.addr.0, %while.cond ]
  %inc = add nsw i32 %vSSA_sigma, 1
  br i1 undef, label %if.then, label %while.body.if.end_crit_edge
